...
let __lazy_useCacheClient: CacheClient | typeof __compdi_uninitialized = __compdi_uninitialized;
const __peek_useCacheClient = () => __lazy_useCacheClient === __compdi_uninitialized ? undefined : __lazy_useCacheClient;
export const useCacheClient = () => {
  if (__lazy_useCacheClient === __compdi_uninitialized) __lazy_useCacheClient = new CacheClient();
